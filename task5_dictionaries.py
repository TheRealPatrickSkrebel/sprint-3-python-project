...
# a) Dictionary mapping each genre to its total global sales
sales_by_genre = {}
...
# b) Dictionary counting how many games each publisher has in the dataset
games_per_publisher = {}
for game in video_game_sales:
...
# c) Dictionary storing details of the #1 ranked game
top_game = {
