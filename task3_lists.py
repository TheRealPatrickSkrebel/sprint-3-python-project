...
# a) Extract all 20 game names into a list
game_names = []
...
# b) Append the new game and print updated dataset length
...
# c) Store metadata in a tuple and explain rationale
# A tuple is more appropriate than a list here because dataset metadata consists of fixed, 
# immutable properties that should not be accidentally modified or reordered during program execution.
