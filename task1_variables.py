...
video_game_sales = [
    [1, 'Wii Sports', 'Wii', 2006, 'Sports', 'Nintendo', 41.49, 29.02, 3.77, 82.74], # ID, NAME, PLATFORM, YEAR, GENRE, PUBLISHER, NA_SALES, EU_SALES, JP_SALES, GLOBAL_SALES
...
total_games = 0
for value in video_game_sales:
    total_games += 1

print(total_games)  # Output: 20

# Calculate total global sales and average global sales
...
print(f"Average global sales across all 20 games: {avg_global_sales:.2f} million copies")

# Calculate total global sales
total_global_sales = sum(game[GLOBAL_SALES] for game in video_game_sales)

# Extract Wii Sports sales (index 0) and calculate share percentage
